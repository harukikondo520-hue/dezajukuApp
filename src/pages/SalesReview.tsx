...
const SALES_TYPES = [
  { id: 'crowdsourcing', label: 'クラウドソーシング提案文', icon: '💼' },
  { id: 'dm', label: 'SNS DM営業', icon: '📱' },
  { id: 'email', label: 'メール営業', icon: '📧' },
  { id: 'portfolio', label: 'ポートフォリオ自己紹介', icon: '🎨' },
  { id: 'profile', label: 'プロフィール文', icon: '👤' },
];
      ...
      <div className="flex-shrink-0 bg-white border-b border-slate-200 px-4 py-3">
        <div className="max-w-2xl mx-auto flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500">営業文・提案文の添削</p>
          </div>
        </div>
      </div>
            ...
            <div>
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-sm text-slate-500">
                  5つの観点で採点し、改善版の例文も提示します
                </p>
              </div>

              {/* 評価観点 */}
              <div className="bg-slate-50 rounded-2xl p-4 mb-6">
                <p className="text-xs font-medium text-slate-500 mb-2">評価観点</p>
                <div className="flex flex-wrap gap-2">
                  {['フック', '信頼性', 'ベネフィット', '差別化', 'CTA'].map((point) => (
                    <span key={point} className="px-3 py-1 bg-white rounded-full text-xs font-medium text-slate-600 border border-slate-200">
                      {point}
                    </span>
                  ))}
                </div>
              ...
              <div className="mb-6">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 bg-slate-100 border border-slate-200 rounded-xl text-sm resize-none focus:outline-none focus:ring-2 focus:ring-purple-500"
                  rows={8}
                />
              </div>
              ...
              <button
                ...
                className="w-full py-4 bg-purple-500 text-white font-bold rounded-xl hover:bg-purple-600 transition flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isLoading ? (
        ...
        <div className="flex-shrink-0 border-t border-slate-200 bg-white px-4 py-3">
          <div className="max-w-2xl mx-auto flex items-center gap-2">
            <input
              ...
              placeholder="追加の質問..."
              className="flex-1 px-4 py-3 bg-slate-100 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-purple-500"
              onKeyDown={(e) => {
