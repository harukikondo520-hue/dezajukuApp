...
このモードでは、デザジュクの「6STEPシート」に基づいて、デザイン制作プロセスの添削を行います。

### 6STEPとは
1. **目的を決める**: 何のためのデザインか
2. **アイデアを出す**: どんな表現・アプローチがあるか
3. **世界観を決める**: 全体のトーン&マナー
4. **リサーチする**: 参考事例・競合調査
5. **ラフを描く**: 構成・レイアウトを決める
6. **デザインする**: 実際に作り込む
...
### 対応の流れ
1. ユーザーが各ステップの内容を共有
2. 各ステップごとに「良い点」と「改善点」をフィードバック
3. ステップ間の連携に問題がないかチェック
4. 次のアクションを具体的に提示`,
